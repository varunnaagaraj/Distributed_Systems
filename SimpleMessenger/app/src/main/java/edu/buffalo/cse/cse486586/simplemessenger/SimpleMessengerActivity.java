...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            {
                while(true) {
                    // Accept the server socket connection and keep it active (Since it is the server and it needs to be running constantly.
                    Socket s = serverSocket.accept();
                    // Create Input Stream to input the message
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                // The message that has to be sent to the server to be routed to the correct destination.
                String msgToSend = msgs[0];
                // Create an output stream to write the message.
